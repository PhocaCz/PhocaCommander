...
echo '<input name="orderinga" type="hidden" value="'.htmlspecialchars($this->t['orderinga'], ENT_QUOTES, 'UTF-8').'" />'. "\n";
echo '<input name="orderingb" type="hidden" value="'.htmlspecialchars($this->t['orderingb'], ENT_QUOTES, 'UTF-8').'" />'. "\n";
echo '<input name="directiona" type="hidden" value="'.htmlspecialchars($this->t['directiona'], ENT_QUOTES, 'UTF-8').'" />'. "\n";
echo '<input name="directionb" type="hidden" value="'.htmlspecialchars($this->t['directionb'], ENT_QUOTES, 'UTF-8').'" />'. "\n";
echo '<input name="foldera" type="hidden" value="'.htmlspecialchars($this->t['foldera'], ENT_QUOTES, 'UTF-8').'" />'. "\n";
echo '<input name="folderb" type="hidden" value="'.htmlspecialchars($this->t['folderb'], ENT_QUOTES, 'UTF-8').'" />'. "\n";
echo '<input name="panel" type="hidden" value="'.htmlspecialchars($this->t['panel'], ENT_QUOTES, 'UTF-8').'" />'. "\n";
echo '<input name="activepanel" type="hidden" value="'.htmlspecialchars($this->t['activepanel'], ENT_QUOTES, 'UTF-8').'" />'. "\n";
